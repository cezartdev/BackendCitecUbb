...
class Commune {
	...
	//TODO: Revisar las claves primarias de esta tabla
    static async initTable(): Promise<void> {
       
        const createTableQuery = `
            CREATE TABLE IF NOT EXISTS ${this.nombreTabla} (
                id int NOT NULL AUTO_INCREMENT COMMENT 'ID unico de la comuna',
                nombre varchar(30) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Nombre de la comuna',
				provincia int NOT NULL COMMENT 'ID de la provincia asociada',
        ...
        const insertDataQuery = `
            INSERT INTO ${this.nombreTabla} (id, nombre, provincia ) VALUES
                (1101,'Iquique',11),
